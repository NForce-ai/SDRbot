...
class TokenTracker:
    ...
    Simply tracks what the API reports - starts at 0 and updates
    based on API responses.
    """

    def __init__(self) -> None:
        self.current_context = 0  # Total context from API
        self.last_output = 0
    ...
    def add(self, input_tokens: int, output_tokens: int) -> None:
        ...
        """
        # Current context = what was sent + what was generated
